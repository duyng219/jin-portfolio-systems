...
#property description "JINPA v2.4 - Manual Trading Assistant"
...
int OnInit()
{
    ...
    if(!g_panel.Create(0, "JINPA v2.4", 0, panelX, panelY, panelX + panelW, panelY + panelH))
    {
    ...
    Print("JINPA v2.4 initialized successfully.");
...
void OnDeinit(const int reason)
{
    ...
    Print("JINPA v2.4 stopped — reason: ", reason);
}
