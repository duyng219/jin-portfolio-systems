# JINPA v2.3 - Tai lieu van hanh nhanh

JINPA v2.3 la EA ho tro giao dich thu cong theo Price Action. EA khong tu vao lenh theo tin hieu indicator; trader chon setup tren panel va bam nut de dat lenh. Phan tu dong chinh cua EA la tinh lot, gan comment setup, tinh SL theo ATR/fixed, quan ly pending order, theo doi daily drawdown va trailing stop theo ATR.
...
- Tao panel `JINPA v2.3` tren chart.
...
```text
JINPA_v2.3_<SYMBOL>_<YYYY-MM-DD>.csv
```
...
Day la default trong `JINPA_v2.3`.
