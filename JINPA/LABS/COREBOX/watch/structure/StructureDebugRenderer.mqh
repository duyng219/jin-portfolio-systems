...
public:
   CStructureDebugRenderer() : m_prefix("JINPA_COREBOX_LAB_STRUCT_"),
                               m_swingPrefix("JINPA_COREBOX_LAB_SWING_"),
                               m_brokenCorePrefix("JINPA_COREBOX_LAB_BROKEN_"),
                               m_sidewayHighPrefix("JINPA_COREBOX_LAB_SIDEWAY_HIGH_"),
                               m_sidewayLowPrefix("JINPA_COREBOX_LAB_SIDEWAY_LOW_")
   {
      m_chartId = 0;
      m_enabled = false;
      m_showCoreBox = true;
               ...
               const SidewayBoxRecord &sidewayBoxes[])
   {
      ...
      UpdateCoreLine(m_prefix + "CORE_HIGH", coreHigh,
                     coreColor, "JINPA COREBOX LAB | Core High");
      UpdateCoreLine(m_prefix + "CORE_LOW", coreLow,
                     coreColor, "JINPA COREBOX LAB | Core Low");
