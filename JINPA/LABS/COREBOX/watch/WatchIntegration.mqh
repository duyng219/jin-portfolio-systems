...
void CWatchIntegration::ProcessTick(void)
{
    ...
    // LAB safety contract: retain the complete notification dependency and
    // consume the machine-readable event stream, but never enqueue or send a
    // real Push notification from this experimental EA.
