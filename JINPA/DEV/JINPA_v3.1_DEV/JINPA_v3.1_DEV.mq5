...
#property description "JINPA v3.1 DEV - Development / Research / Backtest"
...
int OnInit()
{
    ...
    {
        Print("[JINPA][v3.1 DEV][ERROR] Invalid Structure configuration",
    ...
    if(!watchIntegration.ConfigureStructure(SwingLeftBars,
                                            ...
                                            ShowStructureSwings))
    {
        Print("[JINPA][v3.1 DEV][ERROR] Structure configuration rejected");
        return INIT_PARAMETERS_INCORRECT;
    }
...
void OnDeinit(const int reason)
{
    ...
    Print("JINPA v3.1 DEV stopped — reason: ", reason);
}
